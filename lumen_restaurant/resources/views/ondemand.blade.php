...
<head>
	...
	<style>
		...
		p {
			font-family: Montserrat-Regular; font-size: 1.3rem; color: #000;
		}
	</style>
</head>
<body class="animsition">
	...
	<section class="bg-title-page flex-c-m p-t-150 p-b-80 p-l-15 p-r-15">
		<div class="row">
			<div class="col-md-1"></div>
			<div class="col-md-10">
				<h2 style="font-family: Montserrat-Bold">On Demand</h2>
				<br>
				<p class="texto">
	...
	<section class="bg-title-page flex-c-m p-b-80 p-l-15 p-r-15" style="background-color: #f2f2f3;">
		<div class="row">
			<div class="col-md-1"></div>
			<div class="col-md-10">
				<div class="row">
					<div class="col-md-4">
						<img src="/images/carne.png" class="p-t-40" style="width: 100%;">
					</div>
				...
				<br>
				<p class="p-l-20 p-r-20 p-t-20">
					<h2 style="font-family: Montserrat-Bold">
						On Demand para Hotelaria
					</h2>
					<br>
					...
					<p class="texto">					
						...
						proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
						<br><br>
						Vem com a gente nessa nova experiência?
					</p>
	...
	<script>
		if(isMobile()){
			$('.texto').css({'font-family': 'MontserratAlternates-Medium'});
			$('#menu_desktop').hide();
			$('#logo_mobile').show();
		}
	</script>
