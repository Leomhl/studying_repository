...
add_filter( 'of_sanitize_iconpicker', 'sanitize_text_field' );
...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'onetake' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'onetake' ),
		'repeat-y'  => __( 'Repeat Vertically', 'onetake' ),
		'repeat'    => __( 'Repeat All', 'onetake' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'onetake' ),
		'top center'    => __( 'Top Center', 'onetake' ),
		'top right'     => __( 'Top Right', 'onetake' ),
		'center left'   => __( 'Middle Left', 'onetake' ),
		'center center' => __( 'Middle Center', 'onetake' ),
		'center right'  => __( 'Middle Right', 'onetake' ),
		'bottom left'   => __( 'Bottom Left', 'onetake' ),
		'bottom center' => __( 'Bottom Center', 'onetake' ),
		'bottom right'  => __( 'Bottom Right', 'onetake')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'onetake' ),
		'fixed'  => __( 'Fixed in Place', 'onetake')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'onetake' ),
		'italic'      => __( 'Italic', 'onetake' ),
		'bold'        => __( 'Bold', 'onetake' ),
		'bold italic' => __( 'Bold Italic', 'onetake' )
		);
