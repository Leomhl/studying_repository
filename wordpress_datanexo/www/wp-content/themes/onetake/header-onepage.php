...
<body <?php body_class(); ?>>
      ...
      <?php
        ...
        ?>
	<header id="ot-head-container" class="header-home header">
		<div class="container">
        ...
        <?php } else{ ?>
         ...
         <?php } ?>
				...
				<nav class="site-nav" role="navigation">
					<?php 
					 wp_nav_menu(array('theme_location'=>'onepage','depth'=>0,'fallback_cb' =>false,'container'=>'','container_class'=>'onepage-nav','menu_id'=>'onepage-nav','menu_class'=>'ot-navbar','link_before' => '<span>', 'link_after' => '</span>','items_wrap'=> '<ul id="%1$s" class="%2$s">%3$s</ul>'));
					?>
				</nav>
				</div>
			</div>
