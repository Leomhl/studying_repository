			...
			<div class="container">
				...
				for($i=0;$i<9; $i++){
					...
					?>
							...
							<p>&copy; <?php echo date("Y");?>, <?php printf(__('Powered by <a href="%s">WordPress</a>. Designed by <a href="%s">HooThemes</a>.','onetake'),esc_url('http://wordpress.org/'),esc_url('http://www.hoothemes.com/'));?></p>
						</div>
					</div>
				</div>
			</div>
