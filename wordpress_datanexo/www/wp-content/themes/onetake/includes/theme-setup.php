...
add_action( 'after_setup_theme', 'onetake_setup' );
 ...
 function onetake_custom_scripts(){
	 global $onetake_default_options;
	 $onetake_default_options = onetake_get_default_options();
	...
	wp_enqueue_style('font-awesome',  get_template_directory_uri() .'/css/font-awesome.min.css', false, '4.1.0', false);
	...
	wp_enqueue_script( 'queryloader2', get_template_directory_uri().'/js/queryloader2.js', array( 'jquery' ), '', false );
	wp_enqueue_script( 'smoothscroll', get_template_directory_uri().'/js/SmoothScroll.js', array( 'jquery' ), '0.99', true );
  ...
  function onetake_admin_scripts(){
	...
	wp_enqueue_style('onetake-options',  get_template_directory_uri() .'/css/options.css', false, $theme_info->get( 'Version' ), false);
