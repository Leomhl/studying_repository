...
function optionsframework_options() {
   ...
   /**
	...
	$options[] = array(
	 ...
	 //$options[] = array(	'desc' =>'<div class="options-section"><h3 class="groupTitle">'.__('Video Background Options', 'onetake').'</h3>',	'class' => 'toggle_option_group group_close','type' => 'info');
	  ...
	  $options[] = array('name' => '','id' => 'youtube_video_group','type' => 'start_group','class'=>''); 
	   ...
	   $options[] =   	 array(
        ...
        'name'       => __( 'YouTube Video Background Options', 'onetake' ).' <span id="accordion-group-youtube_video" class="textblock-titled-arrows fa fa-plus"></span>',
        'desc'        => '',
        'std'         => '',
	 ...
	 $options[] = array('name' => __('Section Background Video', 'onetake'),'std' => '1TFC-nttP3U','desc' => __('YouTube Video ID', 'onetake'),'id' => 'youtube_background_video','type' => 'text','class'=>'accordion-group-item accordion-group-youtube_video');
		
	$options[] = array('name' => __('Display Buttons', 'onetake'), 'desc' => __('Display video control buttons.', 'onetake'),'id' => 'video_controls', 'std' => '1','class' => 'mini accordion-group-youtube_video accordion-group-item', 'options' => array('1'=>'yes','0'=>'no'),'type' => 'select');
	
	$options[] = array('name' => __('Video Loop', 'onetake'), 'desc' => __('Play video loop.', 'onetake'),'id' => 'youtube_video_loop', 'std' => '1','class' => 'mini accordion-group-youtube_video accordion-group-item', 'options' => array('1'=>'yes','0'=>'no'),'type' => 'select');
	
	$options[] = array('name' => __('Default Volum', 'onetake'),'desc' => '','id' => 'default_volum','type' => 'select', 'class' => 'mini accordion-group-youtube_video accordion-group-item', 'std' => '10','options' => array_combine(range(0,100,10), range(0,100,10)) );
	
	$options[] = array('name' => __('Seeks To', 'onetake'),'std' => '3','desc' => __('Seeks to a specified time in the video ( number of seconds ).', 'onetake'),'id' => 'youtube_seekto','type' => 'text','class' => 'accordion-group-youtube_video accordion-group-item');
	...
	$options[]  = array('name' => __('Video Background Section', 'onetake'),'std' => '1','id' => 'video_background_section', 'type'  => 'select','options'=>$video_background_section, 'class' => 'accordion-group-youtube_video accordion-group-item');
...
<div class="col-md-6 fa-2"> 
   <i class="fa fa-phone">&nbsp;</i>(+01) 0123 456 789
		...
		$section_name = of_get_option('section_title_'.$i);
		$section_name = $section_name?$section_name:of_get_option('menu_title_'.$i);
        $section_name = $section_name?$section_name:sprintf(__('Section %s', 'onetake'),($i+1));
		...
		$options[] =   	 array(
						  ...
						  'name'       =>' '. $section_name .' <span id="accordion-group-section-'.$i.'" class="textblock-titled-arrows fa fa-plus"></span>',
						  'desc'        => '',
						  'std'         => '',
						  'type'        => 'textblock-titled',
						  'rows'        => '',
		...
		'std' => '',
		'type' => 'info',
		'class'=>'section-item section-delete-button  accordion-group-item accordion-group-section-'.$i);
		
		$options[] = array('name' => __('Section Title', 'onetake'),'id' => 'section_title_'.$i.'','type' => 'text','std'=>$section_title[$i], 'class'=>'accordion-group-item accordion-group-section-'.$i);
		$options[] = array('name' => __('Title Color', 'onetake'),'id' => 'section_title_color_'.$i.'','type' => 'color','std'=>$section_title_color[$i], 'class'=>'accordion-group-item accordion-group-section-'.$i);
		$options[] = array('name' => __('Title Border Color', 'onetake'),'id' => 'section_title_border_color_'.$i.'','type' => 'color','std'=>$section_title_border_color[$i], 'class'=>'accordion-group-item accordion-group-section-'.$i);
		$options[] = array('name' => __('Content Color', 'onetake'),'id' => 'section_content_color_'.$i.'','type' => 'color','std'=>$section_content_color[$i], 'class'=>'accordion-group-item accordion-group-section-'.$i);
		$options[] = array('name' => __('Section ID', 'onetake'),'id' => 'section_anchor_'.$i.'','type' => 'text','std'=>$section_anchor[$i],'desc'=>__('Add anchor tag to jump to specific section on one page without having any space or symbol. This section id will be related with the menu link, it should be call on wp appearance menu by using # after site url. It is usually all lowercase and contains only letters, numbers, and hyphens.', 'onetake'), 'class'=>'accordion-group-item accordion-group-section-'.$i);
		$options[] = array('name' =>  __('Section Background', 'onetake'),'id' => 'section_background_'.$i.'','std' => $section_background[$i],'type' => 'background', 'class'=>'accordion-group-item accordion-group-section-'.$i );
		$options[] = array('name' => __('100% Width Background Image', 'onetake'),'std' => $section_background_size[$i],'id' => 'background_size_'.$i.'',
		'type' => 'select','options'=>array("no"=>"no","yes"=>"yes"), 'class'=>'mini accordion-group-item accordion-group-section-'.$i);
		$options[] = array('name' => __('Full Width', 'onetake'),'std' => 'no','id' => 'full_width_'.$i.'',	'type' => 'select','options'=>array("no"=>"no","yes"=>"yes"), 'class'=>'mini accordion-group-item accordion-group-section-'.$i);
	   $options[] = array('name' => __('Section Css Class', 'onetake'),'id' => 'section_css_class_'.$i.'','type' => 'text','std'=>$section_css_class[$i], 'class'=>'accordion-group-item accordion-group-section-'.$i);
	   $options[] = array('name' => __('Section Content', 'onetake'),'id' => 'section_content_'.$i,'std' => $section_content[$i],'type' => 'editor', 'class'=>'accordion-group-item accordion-group-section-'.$i);
	 //  $options[] = array('desc' => __('</div>', 'onetake'),'class' => 'toggle_title','type' => 'info');
	...
	// FOOTER
	   ...
	   $options[] =   	 array(
        'id'          => 'slide_1_titled',
        'name'       => __('Slide One','onetake').' <span id="accordion-group-slide_1" class="textblock-titled-arrows fa fa-plus"></span>',
        'desc'        => '',
        'std'         => '',
        'type'        => 'textblock-titled',
        'rows'        => '4',
		...
		$options[] = array('name' => __('Image', 'onetake'),'id' => 'onetake_slide_image_1','type' => 'upload','std'=>$imagepath.'banner-1.jpg','class'=>'section-item accordion-group-item accordion-group-slide_1');
	
		$options[] = array('name' => __('Text', 'onetake'),'id' => 'onetake_slide_text_1','type' => 'editor','std'=>'<h1>The jQuery slider that just slides.</h1><p>No fancy effects or unnecessary markup.</p><a class="btn" href="#download">Download</a>','class'=>'section-item accordion-group-item accordion-group-slide_1');
		
		
		$options[] = array('name' => '','id' => 'slide_1_group_','type' => 'end_group');
	   ...
	   $options[] =   	 array(
        'id'          => 'slide_2_titled',
        'name'       => __('Slide Two','onetake').' <span id="accordion-group-slide_2" class="textblock-titled-arrows fa fa-plus"></span>',
        'desc'        => '',
        'std'         => '',
        'type'        => 'textblock-titled',
        'rows'        => '4',
		...
		$options[] = array('name' => __('Image', 'onetake'),'id' => 'onetake_slide_image_2','type' => 'upload','std'=>$imagepath.'banner-2.jpg','class'=>'section-item accordion-group-item accordion-group-slide_2');
		
		$options[] = array('name' => __('Text', 'onetake'),'id' => 'onetake_slide_text_2','type' => 'editor','std'=>'<h1>Fluid, flexible, fantastically minimal.</h1><p>Use any HTML in your slides, extend with CSS. You have full control.</p><a class="btn" href="#download">Download</a>','class'=>'section-item accordion-group-item accordion-group-slide_2');
		
		
		$options[] = array('name' => '','id' => 'slide_2_group_','type' => 'end_group');
	   ...
	   $options[] =   	 array(
        'id'          => 'slide_3_titled',
        'name'       => __('Slide Three','onetake').' <span id="accordion-group-slide_3" class="textblock-titled-arrows fa fa-plus"></span>',
        'desc'        => '',
        'std'         => '',
        'type'        => 'textblock-titled',
        'rows'        => '4',
		...
		$options[] = array('name' => __('Image', 'onetake'),'id' => 'onetake_slide_image_3','type' => 'upload','std'=>$imagepath.'banner-3.jpg','class'=>'section-item accordion-group-item accordion-group-slide_3');
		
		$options[] = array('name' => __('Text', 'onetake'),'id' => 'onetake_slide_text_3','type' => 'editor','std'=>'<h1>Open-source.</h1><p> Vestibulum auctor nisl vel lectus ullamcorper sed pellentesque dolor eleifend.</p><a class="btn" href="#">Contribute</a>','class'=>'section-item accordion-group-item accordion-group-slide_3');
		
    	
		$options[] = array('name' => '','id' => 'slide_3_group_','type' => 'end_group');
		
		
		$options[] = array('name' => '','id' => 'slide_4_group','type' => 'start_group','class'=>''); 
	   $options[] =   	 array(
        'id'          => 'slide_4_titled',
        'name'       => __('Slide Four','onetake').' <span id="accordion-group-slide_4" class="textblock-titled-arrows fa fa-plus"></span>',
        'desc'        => '',
        'std'         => '',
        'type'        => 'textblock-titled',
        'rows'        => '4',
		...
		$options[] = array('name' => __('Image', 'onetake'),'id' => 'onetake_slide_image_4','type' => 'upload','std'=>$imagepath.'banner-4.jpg','class'=>'section-item accordion-group-item accordion-group-slide_4');
		
		$options[] = array('name' => __('Text', 'onetake'),'id' => 'onetake_slide_text_4','type' => 'editor','std'=>'<h1>Uh, that\'s about it.</h1><p>I just wanted to show you another slide.</p><a class="btn" href="#download">Download</a>','class'=>'section-item accordion-group-item accordion-group-slide_4');
		
	
	$options[] = array('name' => '','id' => 'slide_4_group_','type' => 'end_group');
	
	
	$options[] = array('name' => '','id' => 'slide_5_group','type' => 'start_group','class'=>''); 
	   $options[] =   	 array(
        'id'          => 'slide_5_titled',
        'name'       => __('Slide Five','onetake').' <span id="accordion-group-slide_5" class="textblock-titled-arrows fa fa-plus"></span>',
        'desc'        => '',
        'std'         => '',
        'type'        => 'textblock-titled',
        'rows'        => '4',
		...
		$options[] = array('name' => __('Image', 'onetake'),'id' => 'onetake_slide_image_5','type' => 'upload','class'=>'section-item accordion-group-item accordion-group-slide_5');
	 
		$options[] = array('name' => __('Text', 'onetake'),'id' => 'onetake_slide_text_5','type' => 'editor','class'=>'section-item accordion-group-item accordion-group-slide_5');
	 

	$options[] = array('name' => '','id' => 'slide_5_group_','type' => 'end_group');
